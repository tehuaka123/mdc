...
#ifndef _ManderCoinRPC_H_
#define _ManderCoinRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // ManderCoin is not connected
...
/**
 * ManderCoin RPC command dispatcher.
 */
class CRPCTable
{
private:
